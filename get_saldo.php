<?php
    ...
    if ($query->num_rows > 0) {
        while ($row = mysqli_fetch_assoc($query)) {
            ...
            $insert = "INSERT INTO tt_saldo_outstand_divisi (tanggal,kode_jenis_bahan,divisi,total_stock,total_berat,total_tambahan,input_date) VALUES ('$tanggal','$divisi','$kode_jenis_bahan','$stock_akhir','$berat_akhir','$tambahan','$inputDate')";
            $conn->query($insert);
        }
